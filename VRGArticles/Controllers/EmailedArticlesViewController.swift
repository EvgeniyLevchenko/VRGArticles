...
class EmailedArticlesViewController: UIViewController {
    ...
    init(viewModel: ArticlesViewModelType) {
        ...
        self.title = "NYT's Most Emailed Articles"
    }
...
extension EmailedArticlesViewController: UICollectionViewDelegate {
...
// MARK: - Data Source
extension EmailedArticlesViewController {
...
extension EmailedArticlesViewController: UISearchBarDelegate {
