...
class ViewedArticlesViewController: UIViewController {
    ...
    init(viewModel: ArticlesViewModelType) {
        ...
        self.title = "NYT's Most Viewed Articles"
    }
...
extension ViewedArticlesViewController: UICollectionViewDelegate {
...
// MARK: - Data Source
extension ViewedArticlesViewController {
